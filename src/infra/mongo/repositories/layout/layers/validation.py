...
if TYPE_CHECKING:
    ...
    from src.infra.mongo.documents import LayoutLayerValidationDocument

type E = LayoutLayerValidationEntity
type D = LayoutLayerValidationDocument


class Validation(BaseRepository[D]):
