...
if TYPE_CHECKING:
    ...
    from src.infra.mongo.documents import LayoutLayerDefaultDocument

type E = LayoutLayerDefaultEntity
type D = LayoutLayerDefaultDocument


class Default(BaseRepository[D]):
