...
from .constants import _Defaults


class _Settings(BaseSettings):
    model_config = model_config(env_prefix=_Defaults.ENV_PREFIX)
    ...
    PASSWORD: SecretStr = Field(
        default=_Defaults.PASSWORD,
        description="Authentication password",
        max_length=255,
    )
    SCHEMA: str = Field(
        default=_Defaults.SCHEMA,
        description="Connection scheme: mongodb or mongodb+srv",
        pattern="^mongodb(?:\\+srv)?$",
    )
    DATABASE: str = Field(
        default=_Defaults.DATABASE,
    ...
    TLS_CERTIFICATE_KEY_FILE_PASSWORD: str | None = Field(
        default=_Defaults.TLS_CERTIFICATE_KEY_FILE_PASSWORD,
    ...
    TLS_DISABLE_OCSP_ENDPOINT_CHECK: bool = Field(
        default=_Defaults.TLS_DISABLE_OCSP_ENDPOINT_CHECK,
    ...
    UUID_REPRESENTATION: str = Field(
        default=_Defaults.UUID_REPRESENTATION,
    ...
    READ_PREFERENCE_TAGS: str | None = Field(
        default=_Defaults.READ_PREFERENCE_TAGS,
    ...
    MAX_STALENESS_SECONDS: NonNegativeInt | None = Field(
        default=_Defaults.MAX_STALENESS_SECONDS,
    ...
    REPLICA_SET_NAME: str | None = Field(
        default=_Defaults.REPLICA_SET_NAME,
    ...
    WRITE_CONCERN_W: int | str | None = Field(
        default=_Defaults.WRITE_CONCERN_W,
